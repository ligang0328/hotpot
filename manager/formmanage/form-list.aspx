<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form-list.aspx.cs" Inherits="Identifying.manager.formmanage.form" %>
    ...
    <form id="form1" runat="server">
        ...
        <ul class="button">
            ...
            <li id="cusfont">&nbsp;&nbsp;&nbsp; 按时间段查询 开始时间 :
                ...
                日&nbsp;&nbsp; <asp:CheckBox ID="cb_form" runat="server" Text="已使用" OnCheckedChanged="cb_form_CheckedChanged" /> 
        ...
        <div align="center">
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                <tr>
                    ...
                    <th width="8%"  nowrap="nowrap">使用时间</th>
                    <th width="8%"  nowrap="nowrap">使用分店</th>
                ...
                <asp:Repeater ID="repeater_formlist" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center"><%# Eval("fState")%></td>
                            <td align="center"><%# Eval("fInvalidDate")%></td>
                            <td align="center"><%# Eval("fLocal")%></td>
                            <td align="center">
                               <!-- <asp:HyperLink ID="linkEdit" runat="server"
                                    NavigateUrl='<%# Eval("fCode", "edit_student.aspx?fCode={0}") %>' Text="编辑"></asp:HyperLink>
                                |-->
                                <asp:HyperLink ID="linDel" runat="server"
                                    NavigateUrl='<%# Eval("fCode", "del.aspx?fCode={0}") %>' Text="删除"></asp:HyperLink></td>
                        </tr>
                    </ItemTemplate>
            </asp:Repeater>		
